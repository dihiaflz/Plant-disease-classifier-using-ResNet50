...
model_path = f"{working_dir}/plant_disease_model"
...
def load_and_preprocess_image(image_path, target_size=(226, 226)):
    # Load the image
...
def predict_image_class(model, image_path, class_indices):
    ...
    predicted_class_index = np.argmax(input_prediction, axis=1)[0]
